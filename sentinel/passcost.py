...
OUTSIDE_STEEP_ROW = 19  # $2FC4 ADC/BCC 6 + $2FCB DEC/BEQ 8 + $2FD0 DEY/BNE 5
OUTSIDE_STEEP_END = 11  # $2FD1 BNE not taken 2 + $2FD3 JMP 3 + $2F6C RTS 6, less the 5
OUTSIDE_STEEP_BACK = 12  # $2FCE BEQ taken 3 + $2FD6 DEC/JMP 9, less the row tail 8
