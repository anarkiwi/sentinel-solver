...
to elapsed enemy rounds by a single scalar (:data:`ROUNDS_PER_PAN_STEP`) -- which is
what lets a lookahead forecast how far the enemies rotate, and how much they drain,
while the player aims a move.
