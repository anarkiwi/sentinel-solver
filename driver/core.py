...
already-canonical pieces rather than re-deriving them, so there is ONE driver:
  ...
  * enter landscape N  -- :mod:`driver.gen_enter` (the ROM's own generate + enter,
...
from driver import boot, gen_enter, kbd_aim
...
class SentinelDriver:
    ...
    def enter_landscape(self, landscape, settle=1.0):
        ...
        gen_enter.generate_and_enter(self.bm, landscape, log=self.log, settle=settle)
